...
export function build_network_data(input: NetworkDataInput): NetworkRequestData {
    ...
    return {
        ...
        request_body_encoding: derive && request_body ? 'utf8' : null,
        request_body_bytes: derive ? utf8_bytes(request_body) : null,
        ...
        response_body_encoding: derive && response_body ? 'utf8' : null,
        response_body_bytes: derive ? utf8_bytes(response_body) : null,
