...
数据库名：`capture_all_db`，当前版本：`DB_VERSION = 3`。
...
| 单采集 大小 | 500MB |
| 单采集 时长 | 24 小时 |
| 单条 body 截断 | 100MB (`max_body_capture_bytes`) |
| 单条 inline_text | 32KB (`inline_text_max_bytes`) |
| 单条 console arg | 1KB |
