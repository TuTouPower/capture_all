...
**Goal:** Reorganize Record All to match `/home/karon/karson_ubuntu/project_manager/docs/project_structure.md` while preserving extension behavior, build output, tests, and existing feature code.
