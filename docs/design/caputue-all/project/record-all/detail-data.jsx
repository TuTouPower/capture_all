/* Capture All — Detail workbench: icons + mock data (shared via window) */
...
/* selected-request detail (the 500) */
const REQ_DETAIL = {
  m: "GET", url: "https://api.example.com/v1/users", st: 200, dur: 245, size: "12.8 KB",
  protocol: "HTTP/2", initiator: "fetch @ users-service.ts:42", time: "01:42.310",
  resp: `{\n  "data": [\n    { "id": 1, "name": "Alice", "email": "alice@example.com" },\n    { "id": 2, "name": "Bob",   "email": "bob@example.com" }\n  ],\n  "total": 2\n}`,
};

Object.assign(window, { DI, LANES, LANE_DATA, NET_ROWS, CON_ROWS, REQ_DETAIL });
