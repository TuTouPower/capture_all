...
| T012 | security: broaden URL query redaction + fix redact_password precedence | done | claude | task_t012_redaction_rules_broaden | commit pending；src_bridge_mcp_shared_02/HIGH-4 + HIGH-6 |
