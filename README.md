...
| 实时采集 | 采集完成 |
|----------|----------|
| <img src="assets/screenshots/01-live-capture.png" width="628" alt="实时采集"> | <img src="assets/screenshots/02-completed-capture.png" width="628" alt="采集完成"> |

| 时间线总览 | 请求检查器 |
|------------|-----------|
| <img src="assets/screenshots/03-timeline-overview.png" width="628" alt="时间线总览"> | <img src="assets/screenshots/04-request-inspector.png" width="628" alt="请求检查器"> |

| 隐私设置 | 导出任务 |
|----------|----------|
| <img src="assets/screenshots/05-privacy-settings.png" width="628" alt="隐私设置"> | <img src="assets/screenshots/06-export-tasks.png" width="628" alt="导出任务"> |
...
- 当前采集模型需要高影响浏览器权限。
- Bridge 普通 JSON body 上限为 1 MiB；扩展结果回传由 bridge 侧校验，超过 64 MiB 被拒收（64 MiB 仅在 bridge 侧强制，超大结果建议分页或本地导出）。
