...
Run: `cd <USER_HOME>/karson_ubuntu/record_all && npm run build 2>&1 | head -40`
...
Run: `cd <USER_HOME>/karson_ubuntu/record_all && npm run build`

预期：build 成功，无类型错误。

- [ ] **Step 2: 运行单元测试**

Run: `cd <USER_HOME>/karson_ubuntu/record_all && npm test`
