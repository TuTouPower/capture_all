...
- Bridge JSON body limit is 1 MiB; extension result replies are capped by the bridge side at 64 MiB (enforced only on the bridge — prefer pagination or local export for very large results).
